...
def run_research_pipeline(topic : str)-> dict:
    ...
    state["search_results"] = search_result['messages'][-1].content #(-1 gives the final ai message  and -2 gives the tool message , refer img(in the case of create agent format))
